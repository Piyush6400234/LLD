package practice.Threads.Eleven;
...
//            System.out.printf("Ave = %.2f , elapsed = %d nanos or %.2f ms%n", averageParallel, elapsedParallel, elapsedParallel/1000000.0);
    ...
    // Parallelism will only help if the array backing the stream is much much large, for smaller streams overhead will
    // be greater than the time gained due to parallelism
}
