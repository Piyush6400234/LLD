package practice.Threads.Eight;

/* Runnable do not return any value, whereas callable does. Callable return something called future (similar to what is
  a promise in javascript.
  Future is a way for a task to communicate its result, back to the calling code.
*/
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // list of callables returning integers
        ...
        try{
//            var results = multiExecutor.invokeAll(taskList); // returns List of future of Integer types
//            for(var result: results){
//                System.out.println(result.get(500, TimeUnit.MILLISECONDS));
//            }
            var results = multiExecutor.invokeAny(taskList); // returns NOT a future but an integer value. But all the tasks run by the executor.
    ...
    public static void singleMain(String[] args) {
        ...
        if(isDone){
            ...
            if(isDone){
                ...
                if(isDone){
                    System.out.println("All Processed complete.");
                }
            }
