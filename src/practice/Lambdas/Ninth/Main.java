package practice.Lambdas.Ninth;
...
public class Main {
    public static void main(String[] args) {
        ...
        Function<String, String> lastName = s->s+= " Buchalka"; // s.concat(" Buchalka")
        Function<String, String> uCaseLastName = uCase.andThen(lastName);

        System.out.println(uCaseLastName.apply(name));
        System.out.println("-------------------------------------------------------------");

        uCaseLastName = uCase.compose(lastName);  // "Tim Buchalka -> TIM BUCHALKA"
        System.out.println(uCaseLastName.apply(name));
