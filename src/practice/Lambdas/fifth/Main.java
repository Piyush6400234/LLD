package practice.Lambdas.fifth;
...
public class Main {
    public static void main(String[] args) {
        ...
        UnaryOperator<String> everySecondChar = source ->{ // same as Function<String, String> everySecondChar = source ->{ .....
        ...
        var p = everySecondChar.apply("1234567890");
